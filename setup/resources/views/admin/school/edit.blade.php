        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form action="{{ route('admin.school.update', request()->segment(3)) }}" id="school_form" method="post">
                @csrf
                @method('PATCH')
                <div class="card-body">
                  ...
                  <div class="form-group" id="description_container">
                    ...
                    <textarea class="form-control" placeholder="Enter Description" name="description" id="description">{{ $info->description }}</textarea>
                  </div>
...
$(function () {
  ...
  $('#school_category').trigger('change');
  try {
